...
export default function HomeTopBar({
	...
	return (
		<div className="sticky top-0 z-10 bg-kumo-base border-b border-kumo-line">
			<div className="flex items-center gap-3 px-6 lg:px-10 h-16">
				...
				<div className="ml-auto flex items-center gap-2">
					...
					<button
						type="button"
						className="inline-flex items-center gap-1.5 h-9 px-3 rounded-lg border border-kumo-line bg-kumo-base text-sm text-kumo-default hover:bg-kumo-fill transition-colors"
					>
						<FunnelIcon size={15} />
					...
					{showNewMailbox && (
						<button
							...
							className="inline-flex items-center gap-1.5 h-9 px-3 rounded-lg text-sm font-medium text-white transition-opacity hover:opacity-90"
